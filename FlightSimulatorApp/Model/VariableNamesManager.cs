namespace FlightSimulatorApp.Model {
    /*** Class is being used as a parser from variable's names into paths.
     *
     */
    public class VariableNamesManager {
        ...
        public string toPath(string name) {
            switch (name) {
                ...
                case "Longitude":
                    return "/position/longitude-deg";
                case "Latitude":
                    return "/position/latitude-deg";
                case "Elevator":
        ...
        public string toName(string path) {
            switch (path) {
                ...
                case "/controls/flight/elevator":
                    return "Elevator";
                case "/controls/flight/rudder":
                    return "Rudder";
                case "/controls/flight/aileron":
                    return "Aileron";
                case "/controls/engines/engine/throttle":
                    return "Throttle";
                default:
                    return VariableNotFound; /* Error Value */
            }
        }
    }
}